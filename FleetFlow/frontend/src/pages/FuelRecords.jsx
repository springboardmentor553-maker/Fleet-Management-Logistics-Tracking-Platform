...
export default function FuelRecords() {
  ...
  async function handleCreate(e) {
    e.preventDefault()
    if (!form.vehicle_id || !form.driver_id || !form.fuel_quantity || !form.fuel_cost) {
      setFormErr('Vehicle, Driver, Quantity, and Cost are required.')
      return
    }
