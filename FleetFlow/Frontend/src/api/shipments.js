...
export const getMyShipments  = ()       => api.get('/driver/my-shipments').then(r => r.data)
...
export const markShipmentDelivered = (id) => api.patch(`/driver/shipments/${id}/deliver`).then(r => r.data)
