      ...
      >
        ...
        <div className="flex justify-end gap-4 mt-8">
          ...
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 text-white font-semibold hover:from-teal-500 hover:to-emerald-500 shadow-lg shadow-teal-900/20 transition disabled:opacity-50"
          >
            {saving
              ? "Updating..."
              : "Update Fuel Record"}
