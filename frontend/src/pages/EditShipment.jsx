  ...
  return (
    <Layout>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-extrabold bg-gradient-to-r from-teal-300 via-cyan-300 to-emerald-300 bg-clip-text text-transparent">
          Edit Shipment
        </h1>
      ...
      <form
        ...
        className="bg-slate-900/75 backdrop-blur-xl border border-teal-400/20 rounded-2xl shadow-2xl p-8"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="w-full bg-slate-950 border border-teal-500/30 text-white px-4 py-3 rounded-xl outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20 transition"
            >
        ...
        <div className="flex justify-end gap-4 mt-8">
          ...
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-teal-500 via-cyan-500 to-emerald-500 text-white font-semibold hover:from-teal-400 hover:via-cyan-400 hover:to-emerald-400 shadow-lg shadow-teal-900/30 transition disabled:opacity-50"
          >
            {saving
              ? "Updating..."
              : "Update Shipment"}
  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={onChange}
        required={required}
        className="w-full bg-slate-950 border border-teal-500/30 text-white placeholder-slate-500 px-4 py-3 rounded-xl outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20 transition"
      />
